...
class ComplementaryForm(FlaskForm):
    ...
    Creatimia =  SelectField('Evaluacion Radiometrica de EXP', choices=[(x,x) for x in ['N','A','B']])
    AcUrico =  SelectField('Evaluacion Radiometrica de EXP', choices=[(x,x) for x in ['N','A','B']])
