...
from app.models import User, CronicsIlness,Vision,MedicCheck,ArterialTension,Donor,Complementary, BodyExamn,Psicological,Incidents,Patiente,ExpositionRisks,GeneticsRisks,Vacunation, PathologicalHistory,OcupationalHistory, InitialSanitaryControl, InitialHealthState, ChargeSheet, Resume
...
def make_shell_context():
    return {'db': db, 'User': User, 'Patiente': Patiente,
            ...
            'PahtolocalHistory': PathologicalHistory, 'InitialSanitaryControl': InitialSanitaryControl,
